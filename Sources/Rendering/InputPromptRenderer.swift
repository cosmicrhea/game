...
///   prompts.draw(name: "playstation_button_circle", x: 100, y: 100, windowSize: (w, h))
final class InputPromptRenderer {
...
private final class AtlasXMLParserDelegate: NSObject, XMLParserDelegate {

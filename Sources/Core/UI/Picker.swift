...
public final class Picker: OptionsControl {
  ...
  public func draw() {
    ...
    if isFocused, let ctx = GraphicsContext.current {
      ...
      ctx.renderer.drawImage(textureID: leftChevronImage.textureID, in: leftRect, tint: .gray300)
      ctx.renderer.drawImage(textureID: rightChevronImage.textureID, in: rightRect, tint: .gray300)
    }
  }
